...
export function closure1500_externref_shim(a: number, b: number, c: number): void;
export function _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h4652ed4ce7c313bb(a: number, b: number): void;
export function closure1505_externref_shim(a: number, b: number, c: number, d: number): void;
export function _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h05d8f6cd2ffe403d(a: number, b: number): void;
export function closure70837_externref_shim(a: number, b: number, c: number): void;
