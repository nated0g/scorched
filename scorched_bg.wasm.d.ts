...
export function closure1397_externref_shim(a: number, b: number, c: number): void;
export function _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__hf87d02483981f949(a: number, b: number): void;
export function closure1400_externref_shim(a: number, b: number, c: number, d: number): void;
export function _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h0078d50ee5fa71f0(a: number, b: number): void;
export function closure70802_externref_shim(a: number, b: number, c: number): void;
